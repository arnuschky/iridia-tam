...
public class Transition
{
    ...
    private AbstractTask.State fromState;
    // state this transition is going to
    private AbstractTask.State toState;
     ...
     */
    public Transition(AbstractTask task, AbstractTask.State fromState, AbstractTask.State toState,
...
//        log.debug("Adding "+this);
    ...
    public Transition(AbstractTask task, AbstractTask.State fromState, AbstractTask.State toState, boolean fallThrough)
    {
...
//                log.debug(this + " condition '" + condition.name + "' evaluates to false");
     ...
     */
    public AbstractTask.State getFromState()
    {
        return fromState;
    }
     ...
     */
    public AbstractTask.State getToState()
    {
        return toState;
    }

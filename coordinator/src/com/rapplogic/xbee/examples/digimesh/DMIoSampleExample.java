 ...
 */
public class DMIoSampleExample implements PacketListener {

	private final static Logger log = Logger.getLogger(DMIoSampleExample.class);
	
	private DMIoSampleExample() throws Exception {
		XBee xbee = new XBee();		
	...
	public void processResponse(XBeeResponse response) {
		...
		if (response.getApiId() == ApiId.DM_IO_SAMPLE_RESPONSE) {
            DMRxIoSampleResponse ioSample = (DMRxIoSampleResponse) response;

...
import com.rapplogic.xbee.api.digimesh.DMRemoteAtRequest;
 ...
 *
 */
public class DMRemoteAtExample
{
	private final static Logger log = Logger.getLogger(DMRemoteAtExample.class);
	
	private DMRemoteAtExample() throws XBeeException, InterruptedException {
		...
		try {
			...
			//DMRemoteAtRequest request = new DMRemoteAtRequest(addr64, "D0", new int[] {5});
			//DMRemoteAtRequest request = new DMRemoteAtRequest(addr64, "IR", new int[] {0x7f, 0xff});
			//DMRemoteAtRequest request = new DMRemoteAtRequest(addr64, "D5", new int[] {3});
			//DMRemoteAtRequest request = new DMRemoteAtRequest(addr64, "D0", new int[] {2});
			//DMRemoteAtRequest request = new DMRemoteAtRequest(addr64, "P2", new int[] {3});
            DMRemoteAtRequest request = new DMRemoteAtRequest(addr64, "P0", new int[] {1});

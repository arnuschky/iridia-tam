...
/**
 * Series 1 XBee with Digimesh.  Sends a packet to a remote radio.  The remote radio
 * receives the data as a DMRxResponse packet.
 * <p/>
 * API ID: 0x10
 * <p/>
 * @author Arne Brutschy
 */
public class DMTxRequest extends XBeeRequest {
	...
	/**
	 * This is the maximum payload size for DM firmware, as specified in the datasheet.
	 ...
	 * @param payload
	 */
	public DMTxRequest(int frameId, XBeeAddress64 dest64, XBeeAddress16 dest16, int broadcastRadius, Option option, int[] payload) {
	 ...
	 * @param payload
	 */
	public DMTxRequest(XBeeAddress64 dest64, int[] payload) {
		this(XBeeRequest.DEFAULT_FRAME_ID, dest64, XBeeAddress16.ZNET_BROADCAST, DMTxRequest.DEFAULT_BROADCAST_RADIUS, Option.UNICAST, payload);
	}

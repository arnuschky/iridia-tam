 ...
 * receives the packet as a DMExplicitRxResponse packet.
 * <p/>
 ...
 *
 */
public class DMExplicitTxRequest extends DMTxRequest
{
	...
	public DMExplicitTxRequest(int frameId, XBeeAddress64 dest64, XBeeAddress16 dest16, int broadcastRadius, Option option, int[] payload, int sourceEndpoint, int destinationEndpoint, DoubleByte clusterId, DoubleByte profileId) {
	...
	public ApiId getApiId() {
		return ApiId.DM_EXPLICIT_TX_REQUEST;
	}
